  ...
  return (
    <div className="mt-6 flex flex-wrap justify-center gap-2">
      ...
      <Button
        ...
        className="min-h-[44px] min-w-[120px] flex-1 sm:flex-none"
      ...
      <Button
        ...
        disabled={disabled || isSubmitting}
        className="min-h-[44px] min-w-[120px] flex-1 border-orange-500 text-orange-600 hover:bg-orange-50 sm:flex-none dark:border-orange-400 dark:text-orange-400 dark:hover:bg-orange-950"
      ...
      <Button
        ...
        disabled={disabled || isSubmitting}
        className="min-h-[44px] min-w-[120px] flex-1 bg-green-600 hover:bg-green-700 sm:flex-none dark:bg-green-700 dark:hover:bg-green-800"
      ...
      <Button
        ...
        disabled={disabled || isSubmitting}
        className="min-h-[44px] min-w-[120px] flex-1 bg-blue-600 text-white hover:bg-blue-700 sm:flex-none dark:bg-blue-700 dark:hover:bg-blue-800"
