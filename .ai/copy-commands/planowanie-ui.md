...
2. Opis widoku:
   <view_description>
   @.ai/copy-commands/składowe/view-description-plan.md  
   </view_description>

3. User Stories:
   <user_stories>
   @.ai/copy-commands/składowe/user-story-plan.md  
   </user_stories>

4. Endpoint Description:
   <endpoint_description>
   @.ai/copy-commands/składowe/ui-endpoint-plan.md  
   </endpoint_description>
